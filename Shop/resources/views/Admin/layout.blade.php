                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                  <a href="{{ route('activerequests.index') }}" class="nav-link">
                                      <p>Заявки клиентов</p>
                                  </a>
                                </li>

                                <li class="nav-item">
                                    <a href="{{ route('guestrequests.index') }}" class="nav-link">
                                        <p>Заявки гостей</p>
                                    </a>
                                </li>
                            </ul>
                      ...
                      <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                              <a href="{{ route('categorylist.show') }}" class="nav-link">
                                  <p>Категории</p>
                              </a>
                            </li>

                            <li class="nav-item">
                                <a href="{{ route('creators.show') }}" class="nav-link">
                                    <p>Производители</p>
                                </a>
                            </li>
                        </ul>
